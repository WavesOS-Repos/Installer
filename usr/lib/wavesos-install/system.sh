...
# This function now calls the new modular package installation
install_base_system() {
    # This function is now handled in packages.sh
    # Call the new function from packages.sh
    log "Base system installation delegated to packages.sh"
}

# Install bootloader packages - moved to packages.sh  
# This function now calls the new modular package installation
install_bootloader_packages() {
    # This function is now handled in packages.sh
    # Call the new function from packages.sh
    log "Bootloader packages installation delegated to packages.sh"
}

# Install graphics drivers - moved to packages.sh
# This function now calls the new modular package installation
install_graphics_drivers() {
    # This function is now handled in packages.sh
    # Call the new function from packages.sh
    log "Graphics drivers installation delegated to packages.sh"
}

# Install desktop environment - moved to packages.sh
# This function now calls the new modular package installation
install_desktop_environment() {
    # This function is now handled in packages.sh
    # Call the new function from packages.sh
    log "Desktop environment installation delegated to packages.sh"
}

# Install custom packages - moved to packages.sh
# This function now calls the new modular package installation
install_custom_packages() {
    # This function is now handled in packages.sh
    # Call the new function from packages.sh
    log "Custom packages installation delegated to packages.sh"
}
